...
76561198008478190 Aidan
*/

if ((getPlayerUID player) in ["76561198059611014","76561198008478190"]) then { 
	...
	if ((getPlayerUID player) in ["76561198059611014","76561198008478190"]) then { // Super Admin PlayerID Eintragen
		adminmenu =
		[
			["",true],
