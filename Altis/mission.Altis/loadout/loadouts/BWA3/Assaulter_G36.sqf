...
for "_i" from 1 to 6 do {_unit addItemToVest "BWA3_100Rnd_556x45_G36";};
for "_i" from 1 to 3 do {_unit addItemToVest "BWA3_100Rnd_556x45_G36_Tracer";};
_unit addBackpack "milgp_bp_Pointman_cb";
for "_i" from 1 to 6 do {_unit addItemToBackpack "ACE_Sandbag_empty";};
for "_i" from 1 to 2 do {_unit addItemToBackpack "BWA3_100Rnd_556x45_G36";};
_unit addItemToBackpack "BWA3_100Rnd_556x45_G36_Tracer";
_unit addHeadgear "KSK_PLAIN_2";
_unit addGoggles "PBW_Balaclava_schwarz";

comment "Add weapons";
_unit addWeapon "hlc_rifle_G36KV_CMAG";
