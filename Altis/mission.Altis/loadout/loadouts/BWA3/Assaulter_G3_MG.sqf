...
_unit addItemToUniform "hlc_50rnd_762x51_M_G3";
_unit addVest "milgp_v_mmac_hgunner_belt_CB";
for "_i" from 1 to 3 do {_unit addItemToVest "BWA3_15Rnd_9x19_P8";};
for "_i" from 1 to 3 do {_unit addItemToVest "hlc_50rnd_762x51_M_G3";};
_unit addBackpack "fatpack_coy";
for "_i" from 1 to 6 do {_unit addItemToBackpack "hlc_50rnd_762x51_M_G3";};
...
comment "Add weapons";
_unit addWeapon "hlc_rifle_g3ka4_XMAG";
