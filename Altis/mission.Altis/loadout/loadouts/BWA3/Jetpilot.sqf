...
_unit addBackpack "B_ViperHarness_oli_F";
_unit addItemToBackpack "rhs_beanie_green";
_unit addItemToBackpack "O_NVGoggles_urb_F";
...
for "_i" from 1 to 5 do {_unit addItemToBackpack "BWA3_DM32_Orange";};
for "_i" from 1 to 5 do {_unit addItemToBackpack "ACE_Chemlight_HiOrange";};
for "_i" from 1 to 3 do {_unit addItemToBackpack "ACE_HandFlare_Green";};
_unit addHeadgear "FIR_USHelmetType1";
_unit addGoggles "FIR_Visor_Black_down";
