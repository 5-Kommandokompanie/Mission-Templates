...
for "_i" from 1 to 3 do {_unit addItemToVest "hlc_5rnd_300WM_FMJ_AWM";};
_unit addItemToVest "RH_33Rnd_9x19_g18";
...
for "_i" from 1 to 7 do {_unit addItemToBackpack "hlc_5rnd_300WM_FMJ_AWM";};
...
for "_i" from 1 to 2 do {_unit addItemToBackpack "RH_33Rnd_9x19_g18";};
_unit addHeadgear "BWA3_Booniehat_Fleck";
_unit addGoggles "PBW_Balaclava_schwarz";

comment "Add weapons";
_unit addWeapon "hlc_rifle_awMagnum_OD_ghillie";
