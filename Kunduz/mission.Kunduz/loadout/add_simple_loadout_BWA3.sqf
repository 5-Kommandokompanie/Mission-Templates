...
_munit addAction ["<t color='#FCFF00'>Assaulter MG3</t>", { _null = [_this select 1] execVM "loadout\loadouts\BWA3\Assaulter_MG3.sqf" }, player];
...
_munit addAction ["<t color='#FCFF00'>Grundausstattung</t>", { _null = [_this select 1] execVM "loadout\loadouts\BWA3\Grundausstattung.sqf" }, player];